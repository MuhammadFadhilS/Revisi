                    ...
                    <form action="{{ route('product.update', $product) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                placeholder="Nama Produk" name="name" id="name" value="{{ $product->name }}" readonly>
                            @error('name')
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('brand') is-invalid @enderror"
                                placeholder="Nama Brand" name="brand" id="brand" value="{{ $product->brand }}" readonly>
                            @error('brand')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="date" class="form-control @error('expired') is-invalid @enderror"
                                placeholder="Expired" name="expired" id="expired" value="{{ $product->expired }}" readonly>
                            @error('expired')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="number" class="form-control @error('stock') is-invalid @enderror"
                                placeholder="Stock" name="stock" id="stock" value="{{ $product->stock }}" readonly>
                            @error('stock')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
